...
(`site-monitor-hub`). Displays sites overview, site details, cross-site plugin/theme reports.

**PHP 8.2+ minimum.** Strict types everywhere (`declare(strict_types=1)`).

## Architecture

- PSR-4 autoloading under `src/` (namespace `Apermo\SiteMonitorDashboard`)
